...
export const Redo = () => {
  return (
    ...
    >
      ...
      <g transform="matrix(-1 0 0 1 23 0)" fill="none" fillRule="evenodd">
        <mask id="Redo-b" fill="#fff">
          <use xlinkHref="#Redo-a" />
        </mask>
        <use fill="#3465C0" xlinkHref="#Redo-a" />
        <g mask="url(#Redo-b)" fill="#8E99AD">
